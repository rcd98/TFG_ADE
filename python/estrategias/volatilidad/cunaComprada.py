...
class CunaComprada(object):
    ...
    def __init__(self, pe1, p1, pe2, p2, numContratos, numContratos2):
        if (pe1 > pe2):
            ...
            self.eje_y = []
            self.eje_0 = []
            self.nombre = "Cuna Comprada"

            self.rutaImagen, self.eje_x, self.eje_y, self.eje_0 = cunaComprada(self.precioEjercicio, self.precioEjercicio2, self.prima,self.prima2, self.numContratos, self.numContratos2)
        else:
            raise ValueError("El precio de la compra de PUT tiene que ser menor que el de la compra de CALL")

def cunaComprada(precioEjercicio, precioEjercicio2, prima, prima2, numContratos, numContratos2):
