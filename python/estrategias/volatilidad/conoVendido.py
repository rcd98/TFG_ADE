...
class ConoVendido(object):
    ...
    def __init__(self, pe1, p1, pe2, p2, numContratos, numContratos2):
        if (pe1 == pe2):
            ...
            self.eje_y = []
            self.eje_0 = []
            self.nombre = "Cono Vendido"

            self.rutaImagen, self.eje_x, self.eje_y, self.eje_0 = conoVendido(self.precioEjercicio, self.precioEjercicio2, self.prima,self.prima2, self.numContratos, self.numContratos2)
        else:
            raise ValueError("Los precio de ejercicio deben de ser iguales")

def conoVendido(precioEjercicio, precioEjercicio2, prima, prima2, numContratos, numContratos2):
