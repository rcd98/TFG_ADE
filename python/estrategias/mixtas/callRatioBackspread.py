...
class CallRatioBackspread(object):
    ...
    def __init__(self, pe1, p1, pe2, p2, pe3, p3):
        if (pe1 < pe2 and pe1 < pe3 and pe2 == pe3 and p2 == p3):
            ...
            self.eje_y = []
            self.eje_0 = []
            self.nombre = "Call Ratio Backspread"

            self.rutaImagen, self.eje_x, self.eje_y, self.eje_0 = callRatioBackspread(self.precioEjercicio, self.precioEjercicio2, self.precioEjercicio3, self.prima,self.prima2, self.prima3)
        else:
            raise ValueError("No se complen las condiciones del Call Ratio Backspread")

def callRatioBackspread(precioEjercicio, precioEjercicio2, precioEjercicio3, prima, prima2,prima3):
